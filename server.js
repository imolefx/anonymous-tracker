        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; }
                body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background: #0b0f1a; color: #eef2f8; margin: 0; padding: 20px; display: flex; align-items: center; justify-content: center; min-height: 100vh; }
    ...
    db.run(`INSERT INTO links (id, target_url, tracking_id) VALUES (?, ?, ?)`, [linkId, targetUrl, trackingId], (err) => {
        ...
        res.send(`
            ...
            <head>
                ...
                <style>
                    * { box-sizing: border-box; }
                    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background: #0b0f1a; color: #eef2f8; margin: 0; padding: 20px; display: flex; justify-content: center; }
